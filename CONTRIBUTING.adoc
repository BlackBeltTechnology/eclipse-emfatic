...
eclipse-emfatic is currently built on top of JDK 11.
...
You can file new issues by filling out our https://github.com/BlackBeltTechnology/eclipse-emfatic/issues/new/choose[issue form].
